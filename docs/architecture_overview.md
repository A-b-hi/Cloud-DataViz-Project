...
The proposed system follows a layered architecture to ensure modularity, scalability, and ease of deployment. The architecture consists of the following layers:
